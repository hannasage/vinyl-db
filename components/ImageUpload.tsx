...
export default function ImageUpload({ onImageSelect, onError, className = '', iconOnly = false }: ImageUploadProps) {
  ...
  // fallback: render nothing if not iconOnly (legacy mode not used)
  return null;
} 